...
class bbms5:
    def __init__(self,root):
       ...
       # self.root.title("Blood Bank Management System".center(550))
        ...
        Stock_button = Button(self.root, text="Stock", font=("bookman", 20, "bold"), padx=20, fg="#ffa31a",
...
class bbms1:
    def __init__(self,root):
       ...
       # self.root.title("Blood Bank Management System".center(550))
        ...
        blood_Frame2 = LabelFrame(self.root, text="Compatitible Blood Type", bd=10, relief=RIDGE,
                                 font=("Calisto MT", 20, "bold"), fg="#e86464", bg="#423e3e")
